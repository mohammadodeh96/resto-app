                      ...
                      <div class="pt-5 sm:col-span-6">
                        ...
                        <div class="mt-1">
                          <textarea id="description" rows="3" name = "description"
                           class="block w-full appearance-none  border  bg-white py-2 px-3 text-base leading-normal shadow-sm transition duration-150 ease-in-out focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                        </div>
                      </div>
                      @error('description')
                      <div class=" text-sm text-red-400">{{$message}}</div>
